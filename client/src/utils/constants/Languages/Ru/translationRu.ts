export const ru = {
    ...
    'A confirmation letter has been sent to the Email !':'Письмо с подтверждением отправлено на Email !',
    ...
    'Log in with your data that you entered during Your registrarion':'Авторизуйтесь, используя данные, которые вы ввели при регистрации.',
    'Have an account ?':'Уже есть аккаунт?',
    'Create new account':'Создать новый аккаунт',
    'Enter with your data details to create a new account':'Введите свои данные, чтобы создать новую учетную запись',
    'Sign Up':'Зарегистрироваться',
    'Log in':'Войти',
    'Reset Password':'Сброс пароля',
    'To reset your password enter your email':'Для сброса пароля введите свой адрес электронной почты',
    ...
    'Password must not contain cyrillic':'Пароль не должен содержать кириллицы.',
    'Passwords must match':'Пароли должны совпадать',
    'Must have a maximum of 30 characters':'Должно быть не более 30 символов.',
    'The first name must contain only letters':'Имя должно состоять только из букв',
    'First letter must be in upper case':'Первая буква должна быть в верхнем регистре',
